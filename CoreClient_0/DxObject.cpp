...
void DxObject:: Convert(std::vector<SimpleVertex>& list, std::vector<SimpleVertex>& rectlist)
{
	...
	rectlist[0].t.x = 0.0f; rectlist[0].t.y = 0.0f;
	rectlist[1].t.x = 1.0f; rectlist[1].t.y = 0.0f;
	rectlist[2].t.x = 0.0f; rectlist[2].t.y = 1.0f;
	rectlist[3].t = rectlist[2].t;
	rectlist[4].t = rectlist[1].t;
	rectlist[5].t.x = 1.0f; rectlist[5].t.y = 1.0f;
}
